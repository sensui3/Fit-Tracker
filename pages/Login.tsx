...
const Login: React.FC = () => {
  ...
  return (
    <main className="flex min-h-screen min-h-[100dvh] w-full bg-background-light dark:bg-background-dark text-slate-900 dark:text-white">
      ...
      <GranularErrorBoundary name="LoginBranding">
        <div className="hidden lg:flex relative w-1/2 overflow-hidden bg-slate-900 dark:bg-[#0a0f0a]">
          <img
          ...
          <div className="relative z-10 flex flex-col justify-center h-full p-16 gap-6 max-w-[640px]">
      ...
      <section className="flex-1 flex flex-col justify-center items-center px-8 py-12 bg-white dark:bg-[#0f140f]">
        <GranularErrorBoundary name="LoginForm">
