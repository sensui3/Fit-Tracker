...
const Profile: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-4 md:p-8 space-y-8 animate-in fade-in duration-500">
      {/* Header */}
      <GranularErrorBoundary name="ProfileHeader">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 space-y-6">
          <GranularErrorBoundary name="ProfileAvatarStats">
          ...
          {/* Badges */}
          <GranularErrorBoundary name="ProfileBadges">
            <Card className="p-6">
        ...
        <div className="lg:col-span-8 space-y-6">
          {/* Basic Info */}
          <GranularErrorBoundary name="ProfileBasicInfo">
          ...
          {/* Biometrics */}
          <GranularErrorBoundary name="ProfileBiometrics">
            <Card className="p-6 md:p-8">
              <div className="flex items-center gap-2 mb-8 text-slate-900 dark:text-white border-b border-border-light dark:border-border-dark pb-4">
