...
const Reports: React.FC = () => {
  ...
  return (
    <div className="p-6 lg:p-10 max-w-7xl mx-auto flex flex-col gap-8">
      {/* Header */}
      <GranularErrorBoundary name="ReportsHeader">
      ...
      {/* KPI Cards */}
      <GranularErrorBoundary name="ReportsKPIs">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 scroll-mt-24">
        ...
        <GranularErrorBoundary name="ReportsMainChart">
        ...
        <GranularErrorBoundary name="ReportsProgressChart">
      ...
      {/* Table */}
      <GranularErrorBoundary name="ReportsHistoryTable">
