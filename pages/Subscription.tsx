  ...
  return (
    <div className="flex justify-center py-8 px-4 sm:px-6 lg:px-8 pb-20">
      <div className="flex flex-col w-full max-w-5xl gap-8">
        {/* Breadcrumbs & Heading */}
        <GranularErrorBoundary name="SubscriptionHeader">
        ...
        <GranularErrorBoundary name="SubscriptionCurrentPlan">
        ...
        {/* Upgrade Section */}
        <GranularErrorBoundary name="SubscriptionPricing">
          <div className="mt-4">
        ...
        {/* Payment Methods */}
        <GranularErrorBoundary name="SubscriptionPaymentMethods">
        ...
        {/* Footer Link */}
        <GranularErrorBoundary name="SubscriptionFooter">
